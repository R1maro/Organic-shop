...
export default function SignInClient() {
    ...
    useEffect(() => {
        ...
        if (errorParam === 'session_expired') setError('Your session has expired. Please log in again.');
        else if (errorParam === 'network_error') setError('Network error occurred. Please try again.');
    }, [searchParams]);
                ...
                <div className="flex flex-wrap items-center min-h-screen">
                    <div className="hidden w-full xl:block xl:w-1/2">
                        <div className="px-26 py-17.5 text-center">
                            <Link className="mb-5.5 inline-block" href="/">
                                <Logo className="object-cover w-50"/>
                            </Link>
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <span className="mb-1.5 block font-medium">Login to your account</span>
                            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                Sign In to Organic-Shop
                            </h2>

                            <form onSubmit={handleSubmit}>
                                {error && (
                                    <div
                                        className="mb-4 rounded-lg bg-red-50 p-4 text-sm text-red-500 dark:bg-red-500/20">
                                        {error}
                                    </div>
                                )}
                       ...
                       >
                                ...
                                <div className="mb-6">
                                    <label
                                        className="mb-2.5 block font-medium text-black dark:text-white">Password</label>
                                    <div className="relative">
                                        <input
                                            type="password"
                                            value={password}
