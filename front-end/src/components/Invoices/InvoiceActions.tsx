...
export function InvoiceActions({ invoice }: { invoice: Invoice }) {
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`${config.API_URL}/admin/invoices/${invoice.id}`, {
                method: 'DELETE',
                headers: {
        ...
        <div className="flex items-center space-x-3.5">
            ...
            >
                ...
                >
                    ...
                    />
                    <path
                        d="M9.00039 9.11255C8.66289 9.11255 8.35352 9.3938 8.35352 9.75942V13.3313C8.35352 13.6688 8.63477 13.9782 9.00039 13.9782C9.33789 13.9782 9.64727 13.6969 9.64727  9.75942V13.3313C9.64727 12.9938 9.36602 12.6844 9.00039 12.6844Z"
                        fill=""
                    />
                </svg>
            </button>
